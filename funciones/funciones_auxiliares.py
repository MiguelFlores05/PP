...
def valores_booleanos(dataset):
    ...
    ----------------------------------------------------------------------------------------------------------
        - Descripción : Función que recibe un dataset y transforma las columnas con el contenido deseado.
        - Inputs : 
            -- dataset: Pandas DataFrame que contiene los datos a procesar.
        - Return:
    ...
    for column in dataset.columns:
        # Solo procesa columnas que contengan valores que puedan ser convertidos a 0 y 1
        try:
            # Intentamos reemplazar los valores
            dataset[column] = (
                dataset[column]
            ...
            # Si la columna tiene valores que no pueden convertirse a entero, la dejamos igual
            print(f"Columna '{column}' contiene valores no convertibles a enteros. Se omite.")
    return dataset
